...
const translations = {
  pt: {
    ...
    'projects.financial': 'Fluxo de caixa',
    ...
    // Financial
    'financial.title': 'Fluxo de caixa',
    'financial.revenues': 'Entradas',
    'financial.costs': 'Custos',
    'financial.newRevenue': 'Nova Entrada',
    'financial.newCost': 'Novo Custo',
    'financial.editRevenue': 'Editar Entrada',
    ...
    'financial.deleteRevenueConfirm': 'Tem certeza que deseja excluir esta entrada?',
    'financial.deleteCostConfirm': 'Tem certeza que deseja excluir este custo?',
    'financial.deleteCompanyMovementConfirm': 'Tem certeza que deseja excluir este movimento da empresa?',
    'financial.dashboard': 'Fluxo de caixa',
    'financial.period': 'Período',
    'financial.totalRevenue': 'Total de Entradas',
    'financial.materialCosts': 'Custos de Materiais',
    'financial.laborCosts': 'Custos de Mão de Obra',
    'financial.viewCards': 'Cards',
    'financial.viewChart': 'Grafico',
    'financial.filterByProject': 'Filtrar por obra',
    'financial.allProjects': 'Todas as obras',
    'financial.viewAll': 'Ver tudo',
    'financial.filterType': 'Tipo',
    'financial.filterTypeAll': 'Todos',
    'financial.filterTypeMaterials': 'Materiais',
    'financial.filterTypeLabor': 'Mao de obra',
    ...
    'financial.companyCash': 'Dinheiro da Empresa',
    'financial.companyCashNoPeriodFilter': 'Valor acumulado de todo o histórico (não segue filtro de período).',
    'financial.companyEntries': 'Entradas da Empresa',
    'financial.companyExpenses': 'Saídas da Empresa',
    'financial.companyMovements': 'Movimentos da Empresa',
    'financial.companyType': 'Tipo',
    'financial.companyEntry': 'Entrada',
    'financial.companyExit': 'Saída',
    'financial.companyCategory': 'Categoria',
    'financial.companyCategoryAporte': 'Aporte',
    'financial.companyCategoryExpense': 'Despesa da Empresa',
    'financial.companyCategoryProlabore': 'Pró-labore',
    'financial.companyCategoryOwnerWithdrawal': 'Retirada do Dono',
    'financial.companyCategoryOther': 'Outros',
    ...
    'materials.totalInvested': 'Total investido em materiais',
    ...
    // Leftovers
    'leftovers.title': 'Retorno ao estoque',
    'leftovers.new': 'Novo retorno',
  ...
  en: {
    ...
    // Financial
    'financial.title': 'Cash flow',
    'financial.revenues': 'Entries',
    'financial.costs': 'Costs',
    'financial.newRevenue': 'New Entry',
    'financial.newCost': 'New Cost',
    'financial.editRevenue': 'Edit Entry',
    ...
    'financial.deleteRevenueConfirm': 'Are you sure you want to delete this entry?',
    'financial.deleteCostConfirm': 'Are you sure you want to delete this cost?',
    'financial.deleteCompanyMovementConfirm': 'Are you sure you want to delete this company movement?',
    'financial.dashboard': 'Cash flow',
    'financial.period': 'Period',
    'financial.totalRevenue': 'Total Entries',
    'financial.materialCosts': 'Material Costs',
    'financial.laborCosts': 'Labor Costs',
    'financial.viewCards': 'Cards',
    'financial.viewChart': 'Chart',
    'financial.filterByProject': 'Filter by project',
    'financial.allProjects': 'All projects',
    'financial.viewAll': 'View all',
    'financial.filterType': 'Type',
    'financial.filterTypeAll': 'All',
    'financial.filterTypeMaterials': 'Materials',
    'financial.filterTypeLabor': 'Labor',
    ...
    'financial.companyCash': 'Company Cash',
    'financial.companyCashNoPeriodFilter': 'Accumulated total from all history (not affected by period filter).',
    'financial.companyEntries': 'Company Inflows',
    'financial.companyExpenses': 'Company Outflows',
    'financial.companyMovements': 'Company Movements',
    'financial.companyType': 'Type',
    'financial.companyEntry': 'Entry',
    'financial.companyExit': 'Exit',
    'financial.companyCategory': 'Category',
    'financial.companyCategoryAporte': 'Capital Injection',
    'financial.companyCategoryExpense': 'Company Expense',
    'financial.companyCategoryProlabore': 'Owner Payroll',
    'financial.companyCategoryOwnerWithdrawal': 'Owner Withdrawal',
    'financial.companyCategoryOther': 'Other',
    ...
    'materials.totalInvested': 'Total invested in materials',
    ...
    // Leftovers
    'leftovers.title': 'Stock return',
    'leftovers.new': 'New return',
